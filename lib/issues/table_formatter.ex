defmodule Issues.TableFormatter do
  ...
  We calcualte the width of each column to fit the longest element
  in that column.
  ...
  of column, return a list containing lists of the data in
  ...
  Generate teh lie that goes below the column headings. It is a string of
  hyphens, with + sings where the vertical bar between the columns goes.
  ...
  Given a list of containing rows of data, a list containing the header selectors,
